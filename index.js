...
let val1 = 2
function multiplyThis(n) { // creating a new local execution context (calling a function)
  let ret = n * val1
  return ret
}
...
let val = 7 // declearing value assign a value
function createAdder() {
  function addNumbers(a,b) { // creating a new local execution context
    let ret = a + b
    return ret
  }
  return addNumbers
